...
function view_email(id){
  ...
  .then(email => {
      ...
      btn_arch.className = email.archived ? "btn btn-danger" : "btn btn-primary";
...
function load_mailbox(mailbox) {
  ...
  //Get emails for specified mailbox and user
  fetch(`/emails/${mailbox}`)
  .then(response => response.json())
  .then(emails => {
      //Loop emails and create div for each
      emails.forEach(singleEmail => {
        ...
        newEmail.className = "list-group-icon";
        newEmail.innerHTML = `
