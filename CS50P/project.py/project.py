...
def bitten(old_value, current_value, player_name):
    ...
    if current_value < MAX_VAL:
      print("You now need " + str(MAX_VAL - current_value) + " more moves to win this game. Don't give up!")
...
def ladder(old_value, current_value, player_name):
    ...
    if current_value < MAX_VAL:
      print("You now only need " + str(MAX_VAL - current_value) + " more moves to win this game. Keep going!")
